...
INSERT INTO haven.policies (id, name, description, is_builtin) VALUES
    ('00000000-0000-0000-0000-000000000001', 'owner-all',       'Allows all actions on all resources',           true),
    ('00000000-0000-0000-0000-000000000002', 'member-base',     'Base permissions for instance members',         true),
    ('00000000-0000-0000-0000-000000000003', 'vault-admin-all', 'All content and membership actions in a vault', true),
...
INSERT INTO haven.policy_statements (policy_id, effect, actions, resource_types) VALUES
...
INSERT INTO haven.role_policies (role_id, policy_id) VALUES
